...
let c = 0
for (let x of anu) {
if (c == 0) await conn.sendMessage(m.chat, { image: { url: x }, caption: `✅ *1 of ${anu.length} images.* ✅\n_Other Images has been sent in bot private chat_ 😸` }, { quoted : m })
