...
let handler = async (m, { conn, text }) => {
    ...
    if (!m.quoted && !text) throw '*_Enter a text or reply to a multimedia file_*'
    ...
    m.reply('*✅ Status uploaded successfully, schedule the Bot number in your contact list and ask the Bot owner to add you to their contacts so you can see the statuses*')
    }
handler.help = ['statusup']
handler.tags = ['General']
handler.command = /^statusup$/i
