...
//MESSAGE NOTICES
const smsAvisoRG = () => { return `🩵 𓅓 𓆪 𝙍𝙀𝙎𝙐𝙇𝙏 𓆩 𓅓 🩵\n\n` }
const smsAvisoAG = () => { return `⚠️𓅓 𝙒𝘼𝙍𝙉𝙄𝙉𝙂 𓅓⚠️\n\n` }
const smsAvisoIIG = () => { return `❕𓅓 𝙄𝙉𝙁𝙊𝙍𝙈𝘼𝙏𝙄𝙊𝙉 𓅓❕\n\n` }
const smsAvisoFG = () => { return `❌𓅓 𝙀𝙍𝙍𝙊𝙍 𓅓❌\n\n` }
const smsAvisoMG = () => { return `❗️𓅓 𝙈𝙄𝙎𝙐𝙎𝙀𝘿 𝘼𝘾𝙏𝙄𝙊𝙉 𓅓❗️\n\n` }
const smsAvisoEEG = () => { return `📩𓅓 𝙍𝙀𝙋𝙊𝙍𝙏 𓅓📩\n\n` }
const smsAvisoEG = () => { return `💚𓅓 𝘿𝙊𝙉𝙀 𓅓💚\n\n` }


//PARAMETERS IN COMMANDS
const smsRowner = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙊𝙉𝙇𝙔 𝙈𝙀 𝘼𝙎 𝘼 𝘽𝙊𝙏 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 𝘾𝘼𝙉 𝙐𝙎𝙀 𝙄𝙏!!\`\`\`` }//BOT NUMBER
const smsOwner = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙊𝙉𝙇𝙔 𝙈𝙔 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 𝘾𝘼𝙉 𝙐𝙎𝙀 𝙄𝙏!!\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙊𝙉𝙇𝙔 𝙈𝙊𝘿𝙀𝙍𝘼𝙏𝙊𝙍𝙎 𝘼𝙉𝘿 𝙈𝙔 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 𝘾𝘼𝙉 𝙐𝙎𝙀 𝙄𝙏!!\`\`\`` }//MODERATORS
const smsPremium = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙄𝙎 𝙊𝙉𝙇𝙔 𝘼𝙑𝘼𝙄𝙇𝘼𝘽𝙇𝙀 𝙏𝙊 𝙋𝙍𝙀𝙈𝙄𝙐𝙈 𝙐𝙎𝙀𝙍𝙎 𝘼𝙉𝘿 𝙈𝙔 𝘾𝙍𝙀𝘼𝙏𝙊𝙍!! 𝙏𝙊 𝙂𝙀𝙏 𝙋𝙍𝙀𝙈𝙄𝙐𝙈 𝘽𝙐𝙔 𝘼 𝙋𝘼𝙎𝙎 𝙐𝙎𝙄𝙉𝙂 #𝙥𝙖𝙨𝙨 𝙥𝙧𝙚𝙢𝙞𝙪𝙢\`\`\`` }//PREMIUM USERS
const smsGroup = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝘾𝘼𝙉 𝙊𝙉𝙇𝙔 𝘽𝙀 𝙐𝙎𝙀𝘿 𝙄𝙉 𝙂𝙍𝙊𝙐𝙋𝙎!!\`\`\`` }//FOR GROUPS
const smsPrivate = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝘾𝘼𝙉 𝙊𝙉𝙇𝙔 𝘽𝙀 𝙐𝙎𝙀𝘿 𝙏𝙊 𝙏𝙃𝙀 𝙋𝙍𝙄𝙑𝘼𝙏𝙀!!\`\`\`` }//TO THE PRIVATE
const smsAdmin = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙄𝙎 𝙊𝙉𝙇𝙔 𝙁𝙊𝙍 𝘼𝘿𝙈𝙄𝙉𝙎!!\`\`\`` }//ADMINS
const smsBotAdmin = () => { return `\`\`\`¡¡𝙄 𝙉𝙀𝙀𝘿 𝙏𝙊 𝘽𝙀 𝘼𝘿𝙈𝙄𝙉 𝙎𝙊 𝙔𝙊𝙐 𝘾𝘼𝙉 𝙐𝙎𝙀 𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿!!\`\`\`` }//BOT WITH ADMIN
const smsUnreg = () => { return `\`\`\`¡¡𝙔𝙊𝙐 𝙉𝙀𝙀𝘿 𝙏𝙊 𝘽𝙀 𝙍𝙀𝙂𝙄𝙎𝙏𝙀𝙍𝙀𝘿 𝙏𝙊 𝙐𝙎𝙀 𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿, 𝙒𝙍𝙄𝙏𝙀 #𝙫𝙚𝙧𝙞𝙛𝙮 𝙏𝙊 𝙍𝙀𝙂𝙄𝙎𝙏𝙀𝙍!!\`\`\`` }//VERIFY
const smsRestrict = () => { return `\`\`\`¡¡𝙏𝙃𝙄𝙎 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙄𝙎 𝙍𝙀𝙎𝙏𝙍𝙄𝘾𝙏𝙀𝘿 𝘽𝙔 𝙈𝙔 𝘾𝙍𝙀𝘼𝙏𝙊𝙍!!\`\`\`` }//RESTRICT COMMAND
...
const smsLista1 = () => { return `🌟 GDS-MD INFORMATION 🌟`}
...
//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊✨ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀!!*\n┊💖 @user\n┊📄 *𝙍𝙀𝘼𝘿 𝙏𝙃𝙀 𝙂𝙍𝙊𝙐𝙋 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *𝙇𝙀𝙁𝙏 𝙏𝙃𝙀 𝙂𝙍𝙊𝙐𝙋, 𝘽𝙔𝙀 𝘽𝙔𝙀* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user 𝙔𝙊𝙐 𝘼𝙍𝙀 𝙉𝙊𝙒 𝘼𝘿𝙈𝙄𝙉 𝙄𝙉 𝙏𝙃𝙄𝙎 𝙂𝙍𝙊𝙐𝙋!!*'}
const smsSdemote = () => { return '*@user 𝙉𝙊 𝙇𝙊𝙉𝙂𝙀𝙍 𝘼𝘿𝙈𝙄𝙉 𝙄𝙉 𝙏𝙃𝙄𝙎 𝙂𝙍𝙊𝙐𝙋!!*'}
const smsSdesc = () => { return '*𝙏𝙃𝙀 𝙉𝙀𝙒 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙊𝙁 𝙏𝙃𝙀 𝙂𝙍𝙊𝙐𝙋 𝙄𝙎:*\n\n@desc'}
const smsSsubject = () => { return '*𝙏𝙃𝙀 𝙉𝙀𝙒 𝙉𝘼𝙈𝙀 𝙊𝙁 𝙏𝙃𝙀 𝙂𝙍𝙊𝙐𝙋 𝙄𝙎:*\n\n@subject'}
const smsSicon = () => { return '*𝙏𝙃𝙀 𝙋𝙃𝙊𝙏𝙊 𝙊𝙁 𝙏𝙃𝙄𝙎 𝙂𝙍𝙊𝙐𝙋 𝙒𝘼𝙎 𝘾𝙃𝘼𝙉𝙂𝙀𝘿!!*'}
const smsSrevoke = () => { return '*𝙉𝙊𝙒 𝙏𝙃𝙄𝙎 𝙄𝙎 𝙏𝙃𝙀 𝙉𝙀𝙒 𝙇𝙄𝙉𝙆 𝙊𝙁 𝙏𝙃𝙄𝙎 𝙂𝙍𝙊𝙐𝙋!!*\n\n*@revoke*'}
const smsConexion = () => { return `\n 𓆩 𓅓 𓆪 ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✦ 🟢 CONNECTION ✦┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 𓃠\n│\n│★ SUCCESSFULLY CONNECTED WITH WHATSAPP  🇵🇰\n│\n 𓆩 𓅓 𓆪 ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✦ ✅ ✦┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈  𓆩 𓅓 𓆪`}
const smsCargando = () => { return `🇵🇰 LOADING...\n`}
const smsCodigoQR = () => { return `\n✅ SCAN THE QR CODE EXPIRES IN 45 SECONDS ✅`}
const smsConexionOFF = () => { return `\n⚠️ NO CONNECTION, PUT NEW SESSION ${global.authFile} GET NEW SESSION FROM PAIR CODE⚠️`}
...
//_allantilink.js
const smsTextoYT = () => { return '😍𝙂𝘿𝙎-𝙈𝘿 - 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 - 𝘽𝙊𝙏😍'}
const smsApagar = () => { return '❌ 𝘿𝙀𝘼𝘾𝙏𝙄𝙑𝘼𝙏𝙀𝘿'}
const smsEncender = () => { return '✅ 𝘼𝘾𝙏𝙄𝙑𝘼𝙏𝙀𝘿'}
...
const eGataCoins = () => { return '🐱 GDSCoins' }
const eGataTickers = () => { return '🎫 GDS Tickers' } 
...
const smsModHor1 = () => { return ` null`}
const smsModHor2 = () => { return `null`}
...
const smsConfi2 = () => { return `*ɢᴅs-ᴍᴅ*`}
const smsConfi3 = () => { return `𝗦𝗘𝗟𝗘𝗖𝗧 𝗔𝗡 𝗢𝗣𝗧𝗜𝗢𝗡 𝗙𝗥𝗢𝗠 𝗧𝗛𝗘 𝗟𝗜𝗦𝗧`}
const smsConfi4 = () => { return `𝗧𝗢 𝗦𝗧𝗔𝗥𝗧 𝗖𝗢𝗡𝗙𝗜𝗚𝗨𝗥𝗘`}
const smsConfi5 = () => { return `┃┃𝗖𝗢𝗡𝗙𝗜𝗚𝗨𝗥𝗔𝗧𝗜𝗢𝗡 𝗡𝗢𝗧𝗘𝗦:`}
const smsConfi6 = () => { return `┃┃ 𝗙𝗨𝗡𝗖𝗧𝗜𝗢𝗡 𝗘𝗡𝗔𝗕𝗟𝗘𝗗 ⇢ ✅ `}
const smsConfi7 = () => { return `┃┃ 𝗙𝗨𝗡𝗖𝗧𝗜𝗢𝗡 𝗗𝗜𝗦𝗔𝗕𝗟𝗘𝗗 ⇢ ❌ `}
const smsConfi8 = () => { return `┃┃ 𝗧𝗛𝗜𝗦 𝗖𝗛𝗔𝗧 𝗜𝗦 𝗡𝗢𝗧 𝗔 𝗚𝗥𝗢𝗨𝗣 ⇢ ⚠️ `}
const smsConfi9 = () => { return `┃┃*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ɢᴅs-ᴍᴅ ᴇɴᴀʙʟᴇ ᴅɪsᴀʙʟᴇ ᴍᴇɴᴜ*`}
const smsConfi10 = () => { return `*💗 𓅓 𓆪 𝗖𝗢𝗡𝗙𝗜𝗚𝗨𝗥𝗔𝗧𝗜𝗢𝗡 𝗖𝗘𝗡𝗧𝗘𝗥 𓆩 𓅓 💗*`}
const smsParaAdmins = () => { return `𝗖𝗥𝗘𝗔𝗧𝗢𝗥 𝗔𝗡𝗗 𝗔𝗗𝗠𝗜𝗡𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 : 𝗚𝗥𝗢𝗨𝗣𝗦`}
const smsParaAdYOw = () => { return `𝗖𝗥𝗘𝗔𝗧𝗢𝗥 𝗔𝗡𝗗 𝗔𝗗𝗠𝗜𝗡𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 : 𝗖𝗛𝗔𝗧𝗦`}
const smsParaOw = () => { return `𝗖𝗥𝗘𝗔𝗧𝗢𝗥 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 : 𝗖𝗛𝗔𝗧𝗦`}
const smsNoGg = () => { return ` | ⚠️`}
const smsMens1 = () => { return `┃🩵 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 `} 
const smsMens2 = () => { return `┃🩵 𝘾𝙐𝙍𝙍𝙀𝙉𝙏𝙇𝙔 `} 
const smsMens3 = () => { return `┃🩵 𝙄𝙉 𝙏𝙃𝙄𝙎 `} 
const smsMens4 = () => { return `𝘽𝙊𝙏 `} 
const smsMens5 = () => { return `𝘾𝙃𝘼𝙏 `} 
...
const smsContacto4 = () => { return 'GDS-MD Official Contact 🐈'}
