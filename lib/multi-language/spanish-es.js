...
smsAutodetec4: (usuario, m, groupMetadata) => `🔒 ${usuario}*\n*𝗛𝗔𝗦 𝗔𝗟𝗟𝗢𝗪𝗘𝗗 ${m.messageStubParameters[0] == 'on' ? '𝙎𝙊𝙇𝙊 𝘼𝘿𝙈𝙄𝙉𝙎' : '𝙏𝙊𝘿𝙊𝙎'} 𝙋𝙐𝙀𝘿𝘼𝙉 𝘾𝙊𝙉𝙁𝙄𝙂𝙐𝙍𝘼𝙍 ${groupMetadata.subject}*`, 
smsAutodetec5: (groupMetadata, usuario) => `*𝙀𝙇 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀 ${groupMetadata.subject} 𝙃𝘼 𝙎𝙄𝘿𝙊 𝙍𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝙋𝙊𝙍:*\n*» ${usuario}*`, 
smsAutodetec6: (m) => `𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 *${m.messageStubParameters[0] == 'on' ? '𝗜𝗧'𝗦 𝗖𝗟𝗢𝗦𝗘𝗗 🔒' : '𝗜𝗧'𝗦 𝗢𝗣𝗘𝗡𝗘𝗗 🔓'}*\n ${m.messageStubParameters[0] == 'on' ? '𝗢𝗡𝗟𝗬 𝗔𝗗𝗠𝗜𝗡𝗦 𝗖𝗔𝗡 𝗪𝗥𝗜𝗧𝗘' : '𝗬𝗢𝗨 𝗖𝗔𝗡 𝗡𝗢𝗪 𝗪𝗥𝗜𝗧𝗘 𝗘𝗩𝗘𝗥𝗬𝗧𝗛𝗜𝗡𝗚'} 𝗜𝗡 𝗧𝗛𝗜𝗦 𝗚𝗥𝗢𝗨𝗣*'`, 
smsAutodetec7: (m, usuario) =>  `@${m.messageStubParameters[0].split`@`[0]} ⚡𝗡𝗢𝗪 𝗜𝗦 𝗔𝗗𝗠𝗜𝗡 𝗜𝗡 𝗧𝗛𝗜𝗦 𝗚𝗥𝗢𝗨𝗣\n\n💗𝗔𝗖𝗧𝗜𝗢𝗡 𝗣𝗘𝗥𝗙𝗢𝗥𝗠𝗘𝗗 𝗕𝗬: ${usuario}`, 
smsAutodetec8: (m,  usuario) => `@${m.messageStubParameters[0].split`@`[0]} ⚡𝗕𝗘𝗜𝗡𝗚 𝗡𝗢 𝗠𝗢𝗥𝗘 𝗔𝗗𝗠𝗜𝗡 𝗜𝗡 𝗧𝗛𝗜𝗦 𝗚𝗥𝗢𝗨𝗣\n\n💗𝗔𝗖𝗧𝗜𝗢𝗡 𝗧𝗔𝗞𝗘𝗡 𝗕𝗬: ${usuario}`, 
...
//grupos
smsAdd: 'Hola! me presento, soy GDS-MD , soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!', 
smsAdd2: 'Enviando invitacion a su privado...', 
smsGrup: '𝗡𝗢𝗪 𝗘𝗩𝗘𝗥𝗬𝗢𝗡𝗘 𝗖𝗔𝗡 𝗪𝗥𝗜𝗧𝗘 𝗜𝗡 𝗧𝗛𝗜𝗦 𝗚𝗥𝗢𝗨𝗣!!', 
smaGrup2: '𝗡𝗢𝗪 𝗢𝗡𝗟𝗬 𝗔𝗗𝗠𝗜𝗡𝗦 𝗖𝗔𝗡 𝗦𝗘𝗡𝗗 𝗠𝗘𝗦𝗦𝗔𝗚𝗘!!', 
